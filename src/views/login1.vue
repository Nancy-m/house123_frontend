<template>
    <div class="login-wrap">
      <el-form label-position="left" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0px" class="demo-ruleForm login-container">
        <h3 class="title">後臺登入1</h3>
        <el-form-item prop="username">
          <el-input type="text" v-model="ruleForm.emial" auto-complete="off" placeholder="電子信箱"></el-input>
        </el-form-item>
        <el-form-item prop="password">
          <el-input type="password" v-model="ruleForm.password" auto-complete="off" placeholder="密碼" show-password></el-input>
        </el-form-item>
        <el-checkbox class="remember" v-model="rememberpwd">記住我的信箱</el-checkbox>
            ...
            login(this.ruleForm).then(res => {
              if (res.success) {
                ...
                setTimeout(() => {
                  ...
                  this.$store.commit('login', 'true')
                  this.$router.push({ path: '/unApprove' })
                }, 1000)
              } else {
